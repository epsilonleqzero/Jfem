#include <iostream>
#include <armadillo>
#include "net_tedkwan_cpp_nar_NativeStuff.h"
/*
...
JNIEXPORT jdoubleArray JNICALL Java_net_tedkwan_cpp_nar_NativeStuff_twice(JNIEnv *env, jobject jobj, jdoubleArray jarray) {
    int i;
    jboolean isCopy1;
